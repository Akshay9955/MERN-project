...
//             </select>
//             <input type='date' placeholder='Appointment Date' value=
//               {appointmentDate} onChange={(e) => setAppointmentDate(e.target.value)} />
...
//           <select value={doctorFirstName && doctorLastName ? `${doctorFirstName} ${doctorLastName}` : ""} onChange={(e) => {
...
//           <div>
//             <textarea row="10" value={address} onChange={(e) => setAddress(e.target.value)} placeholder='Address'></textarea>
...
//               style={{ flex: "none", width: "25px" }}></input>
//           </div>
