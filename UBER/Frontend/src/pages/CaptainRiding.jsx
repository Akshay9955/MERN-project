...
{/* 
         ...
         <Link to='/captain-home' className=' right-2 top-2 h-10 fixed w-10 bg-white flex items-center justify-center rounded-full '>
            <i className="ri-logout-box-r-line"></i></Link>
             ...
             onClick={()=>{
               ...
               <h5 className='p-1 text-center w-[95%] absolute top-0 cursor-pointer' onClick={() => {  
           ...
           <div  ref={finishRidePanelRef}  className=' fixed w-full  bg-white  z-10 bottom-0  translate-y-full    px-3 py-8 pt-12'>
